...
- **Screenshots**:
  - Here's a `README.md` file for your project, "Closet.AI – Deploying Static Website using Load Balancer with ARM Template":
...
- **Demo Video**: [YouTube Demo](https://youtube.com/example)
- **Screenshots**:
  - ![ResourceGroup Screenshot](./ProjectScreenshots/ResourcegroupSS)
